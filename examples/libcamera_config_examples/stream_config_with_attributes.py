...
def main():
    ...
    options.main.size = (1280, 720)
    options.main.role = STILL
    options.main.buffer_count = 3
    options.main.pixel_format = "BGR888"
    options.main.color_space = COLORSPACE_JPEG

    options.lores.size = (640, 480)
